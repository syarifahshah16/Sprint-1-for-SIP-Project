...
class TabPanel(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.list_ctrl_1.AppendColumn("Reconstructed File Path", format=wx.LIST_FORMAT_LEFT, width=200)
        self.list_ctrl_1.AppendColumn("Source Host", format=wx.LIST_FORMAT_LEFT, width=200)
        self.list_ctrl_1.AppendColumn("S.Port", format=wx.LIST_FORMAT_LEFT, width=80)
        self.list_ctrl_1.AppendColumn("Destination Host", format=wx.LIST_FORMAT_LEFT, width=200)
        ...
        self.list_ctrl_1.AppendColumn("Extension", format=wx.LIST_FORMAT_LEFT, width=90)
        self.list_ctrl_1.AppendColumn("Size", format=wx.LIST_FORMAT_LEFT, width=80)
        # end wxGlade
